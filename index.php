<?php include 'inc/header.php';?>
		...
		<div class="wrapper">
			...
			<!-- Section Menu -->
			<section class="section kf-menu  kf-parallax" style="background-image: url(images/res02.jpg);">
				<div class="container">
			...
			<section class="section kf-testimonials kf-testimonials-2 section-bg" style="background-image: url(images/testimonials_bg2.jpg);">
				<div class="container">
